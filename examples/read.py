...
while True:
  ...
  print("CH0-Voltage: " + str (adc.readADCvoltage(i2cAddress, CH1)) + "V")
  print("CH2-Value: " + str (adc.readADCvalue(i2cAddress, CH2)))
  print("CH0-Voltage: " + str (adc.readADCvoltage(i2cAddress, CH2)) + "V")
  print("CH3-Value: " + str (adc.readADCvalue(i2cAddress, CH3)))
  print("CH0-Voltage: " + str (adc.readADCvoltage(i2cAddress, CH3)) + "V")
  print ("-----------------------------------------------------")
  sleep (1)
